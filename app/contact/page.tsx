          ...
          <Reveal delay={0.1}>
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-5 max-w-3xl">
              ...
              >
                ...
                <p className="mt-3 text-xs text-[var(--color-gold-400)] opacity-0 group-hover:opacity-100 transition-opacity">
                  Compose →
                </p>
              </a>
              <a
    ...
    >
      <defs>
        <radialGradient id="contact-glow" cx="80%" cy="70%" r="60%">
          <stop offset="0%" stopColor="rgba(243, 198, 107, 0.22)" />
          <stop offset="60%" stopColor="rgba(243, 198, 107, 0.04)" />
          <stop offset="100%" stopColor="rgba(7, 9, 14, 0)" />
        </radialGradient>
        <linearGradient id="ridge" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="rgba(15, 21, 35, 0.95)" />
          <stop offset="100%" stopColor="rgba(7, 9, 14, 1)" />
        </linearGradient>
      </defs>
      <rect width="1600" height="900" fill="#07090e" />
      ...
      <path d="M0 800 L 200 720 L 480 770 L 720 680 L 980 740 L 1220 670 L 1440 720 L 1600 680 L 1600 900 L 0 900 Z" fill="#07090e" />
      {/* Tower */}
      <g stroke="rgba(243, 198, 107, 0.85)" fill="none" strokeWidth="2">
        ...
        <circle cx="1290" cy="320" r="6" fill="#f3c66b" />
      ...
      {Array.from({ length: 40 }).map((_, i) => {
        ...
        const y = (i * 53.7) % 480;
        const r = (i % 3) * 0.6 + 0.4;
        return <circle key={i} cx={x} cy={y} r={r} fill="#d6dceb" opacity={0.6} />;
      })}
    </svg>
  );
}
