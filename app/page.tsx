  ...
  return (
    <>
      ...
      <Section
        ...
        lede="Math Atlas, simulation prototypes, classifiers, optical-flow solvers, finite element work, particle transport, and image-processing code that make the reasoning inspectable."
      >
