    ...
    <>
            ...
            <Reveal key={s.id} delay={i * 0.05} as="li">
              <Link href={s.href} className="group block h-full">
                <article className="glow-card h-full rounded-2xl p-6 transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:-translate-y-1">
                  ...
                  <p className="mt-6 text-xs text-[var(--color-gold-400)] flex items-center gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
              ...
              >
                <article className="glow-card h-full rounded-2xl p-6">
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      aria-hidden
                      className="font-display text-2xl text-[var(--color-gold-400)] leading-none"
                    >
                      {p.glyph}
                    </span>
                  </div>
              ...
              >
                <article className="glow-card h-full rounded-2xl p-6">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-mono text-[10px] uppercase tracking-[0.18em] text-[var(--color-gold-400)]">
      ...
      >
        <div className="flex flex-wrap items-center justify-center gap-3 mt-2">
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 rounded-full px-6 py-3 text-sm font-medium bg-[var(--color-gold-400)] text-[var(--color-ink-950)] hover:bg-[var(--color-gold-500)] transition-colors shadow-[0_0_60px_-15px_var(--color-gold-400)]"
          >
            Open the channel
            <span aria-hidden>→</span>
          </Link>
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full px-6 py-3 text-sm border border-[var(--line)] hover:border-[var(--color-gold-400)] hover:text-[var(--color-gold-400)] transition-colors"
          >
            hei@trymsaether.no
          </a>
        </div>
